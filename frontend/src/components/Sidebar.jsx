    ...
    >
      ...
      >
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: 9,
                background:
                  "linear-gradient(145deg,rgba(0,70,160,.7),rgba(0,15,50,.95))",
                border: "1px solid rgba(0,229,255,.4)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                boxShadow: "0 0 14px rgba(0,229,255,.2)",
              }}
            >
              <Eye
                style={{
                  ...
                  height: 13,
                  color: "#00E5FF",
                  filter: "drop-shadow(0 0 5px rgba(0,229,255,.9))",
                }}
              />
            </div>
          </div>
            ...
            <div>
              <p
                style={{
                  ...
                  margin: 0,
                  lineHeight: 1.1,
                  background: "linear-gradient(135deg,#fff,#B8D4FF,#00E5FF)",
        ...
        <button
          ...
          onMouseLeave={(e) => {
            ...
            e.currentTarget.style.color = "rgba(0,200,255,.6)";
          }}
        >
          {col ? (
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg,rgba(0,80,200,.6),rgba(0,25,80,.9))",
            ...
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                background: "#00FF9D",
                boxShadow: "0 0 6px rgba(0,255,157,.7)",
                flexShrink: 0,
              }}
            />
          </div>
                ...
                >
                  <Icon
                    style={{
                      width: 16,
                      height: 16,
                      color: active ? "#00E5FF" : "rgba(120,155,200,.5)",
                      filter: active
                        ? "drop-shadow(0 0 5px rgba(0,229,255,.8))"
                        : "none",
                      transition: "all .2s",
                    }}
                  />
                    ...
                    {item.badge && (
                      <span
                        style={{
                          ...
                          border: "1px solid rgba(255,61,113,.28)",
                          borderRadius: 20,
                          color: "#FF3D71",
                          letterSpacing: ".08em",
                        }}
          ...
          {[
            {
              ...
              c: "#00FF9D",
              s: "ACTIVE",
              tip: "Detection engine is running and inspecting traffic in real-time",
            },
            {
              l: "AI Model",
              c: "#00FF9D",
              s: "ONLINE",
              tip: "RandomForest model loaded — 98.7% accuracy on NSL-KDD validation set",
            },
            {
              l: "Fog Nodes",
              c: "#FFB020",
              s: "3/3",
              tip: "3 of 3 fog edge nodes connected — Zone A, B, and C are online",
            },
            {
              l: "Encryption",
              c: "#00E5FF",
              s: "ACTIVE",
              tip: "Fernet AES-128-CBC encryption active — alert payloads encrypted before database storage",
            },
          ].map(({ l, c, s }) => (
            <div
              key={l}
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                ...
                />
                <span style={{ fontSize: 9, color: "rgba(123,145,176,.45)" }}>
                  {l}
                </span>
              </div>
              <span
      ...
      >
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = "rgba(255,61,113,.07)";
            e.currentTarget.style.borderColor = "rgba(255,61,113,.15)";
          }}
          onMouseLeave={(e) => {
        ...
        >
          <div
            style={{
              ...
              border: "1px solid rgba(255,61,113,.12)",
              flexShrink: 0,
            }}
          >
            <LogOut
              style={{ width: 14, height: 14, color: "rgba(255,61,113,.6)" }}
            />
          </div>
          {!col && (
            <span
